...
<body>
  ...
  <div class="form-group">
      ...
      <input type="text" class="form-control" id="Tên đăng nhập" placeholder="Enter tên đăng nhập" name="Txtname">
    </div>
	...
	<div class="form-group">
	  ...
	  <input type="text" class="form-control" id="Hoten" placeholder="Enter họ tên" name="họ tên">
    </div>
	<div class="form-group">
